...
resource "juju_integration" "radarr_hd_seerr" {
...
resource "juju_integration" "radarr_uhd_seerr" {
  count      = var.enable_seerr ? 1 : 0
  model_uuid = data.juju_model.model.uuid
...
resource "juju_integration" "radarr_anime_seerr" {
  count      = var.enable_seerr ? 1 : 0
  model_uuid = data.juju_model.model.uuid
...
resource "juju_integration" "sonarr_hd_seerr" {
  count      = var.enable_seerr ? 1 : 0
  model_uuid = data.juju_model.model.uuid
...
resource "juju_integration" "sonarr_uhd_seerr" {
  count      = var.enable_seerr ? 1 : 0
  model_uuid = data.juju_model.model.uuid
...
resource "juju_integration" "sonarr_anime_seerr" {
  count      = var.enable_seerr ? 1 : 0
  model_uuid = data.juju_model.model.uuid
