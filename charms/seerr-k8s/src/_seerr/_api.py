...
class SeerrApi:
    ...
    def _request(
        ...
        try:
            ...
            raise SeerrApiError(f"API request failed: {e}") from e
    ...
    def is_initialized(self) -> bool:
        ...
        Seerr returns 403 on user-authenticated endpoints until initial
        setup (Plex OAuth / Jellyfin / Emby) creates the admin user.
        """
        try:
