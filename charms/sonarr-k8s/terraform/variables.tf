...
variable "trash_profiles" {
  description = "Comma-separated list of Trash Guide profile templates to sync via Recyclarr (e.g., web-1080p)"
  type        = string
  default     = ""
}

variable "is_4k" {
  description = "Whether this instance handles 4K content (sets root folder to tv-uhd)"
  type        = bool
  default     = false
}
